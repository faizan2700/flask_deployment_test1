...
def run_sample():
    client = cosmos_client.CosmosClient(HOST, {'masterKey': 'm4MQPRRqNNt32VLnbRedud4zMjeWwjCuQozLLV9rr7GyLsfQDP0D5CVN6oRdlAychwAM1d3UoP8iACDbc6WUrg=='}, user_agent="CosmosDBPythonQuickstart", user_agent_overwrite=True)
    # try:
